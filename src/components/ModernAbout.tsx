...
import { Building2, Target, Award, Lightbulb, Globe, Heart } from "lucide-react";
  ...
  const currentRoles = [
    {
      ...
      description: "Leading strategic initiatives in corporate hospital management and medical diagnostics",
    ...
    },
    {
      ...
      description: "Ethics Committee member ensuring responsible medical practices",
    ...
    },
    {
      ...
      description: "Fostering innovation in healthcare startups and entrepreneurship",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20 animate-fade-up">
          <div className="inline-flex items-center space-x-2 bg-primary/10 rounded-full px-6 py-3 mb-6">
            ...
            <span className="text-primary font-medium">About Dr. Muralidhar</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            A visionary leader with over three decades of transformative experience across 
            all healthcare sectors, driving innovation and setting new standards in medical practice and administration.
          </p>
        </div>
          ...
          <Card className="bg-gradient-card border-0 shadow-xl hover-lift">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed max-w-4xl mx-auto">
                "To transform healthcare delivery through strategic management, innovative project leadership, 
                and comprehensive training programs that foster excellence in medical practice. My commitment 
                extends beyond consultation to mentoring the next generation of healthcare leaders and 
                ensuring ethical practices across all medical domains."
              </p>
        ...
        {/* Current Roles Grid */}
        <div className="mb-20">
          <h3 className="text-3xl font-bold text-center mb-12">Current Leadership Positions</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {currentRoles.map((role, index) => (
              <Card key={index} className="group hover-lift animate-fade-up border-0 shadow-lg" style={{ animationDelay: `${index * 0.1}s` }}>
                <CardContent className="p-8 text-center h-full">
                  <div className={`w-16 h-16 bg-gradient-to-r ${role.color} rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300`}>
                    <div className="text-white">
                      {role.icon}
                    </div>
                  </div>
                  <h4 className="font-bold text-lg mb-2">{role.title}</h4>
                  <p className="text-primary font-medium text-sm mb-4">{role.subtitle}</p>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <Card className="bg-gradient-card border-0 shadow-lg hover-lift">
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-bold text-xl mb-3">Pharmaceutical Excellence</h4>
                      <p className="text-muted-foreground mb-4">
                        Strategic roles with industry giants including Novo Nordisk, Abbott, Dr. Reddy's, 
                        Alkem, and Gland Pharma, driving innovation and operational excellence.
                      </p>
              ...
              <Card className="bg-gradient-card border-0 shadow-lg hover-lift">
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-bold text-xl mb-3">Diagnostic Innovation</h4>
                      <p className="text-muted-foreground mb-4">
                        Leadership positions with SRL Diagnostics (Agilus) and Medall Diagnostics, 
                        revolutionizing laboratory management and diagnostic technologies.
                      </p>
                      <div className="flex flex-wrap gap-2">
              ...
              <Card className="bg-gradient-card border-0 shadow-lg hover-lift">
                <CardContent className="p-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-bold text-xl mb-3">Hospital Management</h4>
                      <p className="text-muted-foreground mb-4">
                        Corporate consulting with KIMS and ethics committee leadership at AINU, 
                        ensuring highest standards of patient care and medical ethics.
                      </p>
                      <div className="flex flex-wrap gap-2">
          ...
          <div className="animate-slide-in" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="mt-8 grid grid-cols-2 gap-6">
              <Card className="bg-gradient-accent text-white border-0 shadow-lg hover-lift text-center">
