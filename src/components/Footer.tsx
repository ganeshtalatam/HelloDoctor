          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Healthcare Consultant</p>
              </div>
            </div>
            <p className="text-muted-foreground leading-relaxed">
              Senior Advisory Consultant with 30+ years of experience in healthcare management, 
              dedicated to advancing healthcare through strategic leadership and innovation.
            </p>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <Card className="p-4 bg-secondary/50">
                ...
                <p className="text-xs text-muted-foreground">Indian School of Business</p>
              </Card>
              <Card className="p-4 bg-secondary/50">
                <p className="text-sm font-medium">AINU Ethics Committee</p>
                <p className="text-xs text-muted-foreground">Social Scientist/Ethicist</p>
              </Card>
              <Card className="p-4 bg-secondary/50">
                <p className="text-sm font-medium">GUIDEPOINT</p>
                <p className="text-xs text-muted-foreground">Global Advisors, NY</p>
              </Card>
            </div>
          </div>
        </div>
