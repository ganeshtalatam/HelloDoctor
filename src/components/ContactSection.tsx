...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      title: "Message Sent!",
      description:
        "Thank you for your message. Dr. Panchagnula will get back to you soon.",
    });
  ...
  return (
    <section
      id="contact"
      className="py-20 bg-gradient-to-br from-mint-soft/30 via-white to-healthcare-blue/5"
    >
      <div className="container mx-auto px-6">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-navy/70 max-w-3xl mx-auto leading-relaxed">
              Ready to discuss your healthcare management needs? Reach out for
              expert consultation, training programs, or strategic healthcare
              guidance.
            </p>
          </div>
        </ScrollReveal>
            ...
            <div className="lg:col-span-1 space-y-6">
              <div>
                ...
                <p className="text-navy/70 mb-8 leading-relaxed">
                  Connect with Dr. Muralidhar Panchagnula for healthcare
                  management consultation, training, and advisory services.
                </p>
              </div>
                        ...
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1">
                            ...
                            {info.action ? (
                              ...
                              info.details.map((detail, i) => (
                                <div key={i} className="text-sm text-navy/70">
                                  {detail}
                                </div>
                              ))
                            )}
              ...
              <Card className="hover-lift border-0 bg-white/90 backdrop-blur-sm shadow-xl">
                <CardHeader className="pb-6 text-center lg:text-left">
                  ...
                  <p className="text-navy/70 leading-relaxed">
                    Fill out the form below and Dr. Panchagnula will respond to
        ...
        <div className="max-w-4xl mx-auto mt-16">
          <ScrollReveal delay={700}>
            <Card className="hover-lift border-0 bg-gradient-to-br from-navy to-healthcare-blue justify-center  text-white shadow-lg">
              <CardHeader>
